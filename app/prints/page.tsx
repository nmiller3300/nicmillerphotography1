...
export const metadata: Metadata = { title: 'Print Shop — Nic Miller Photography', description: 'Museum-grade archival fine art prints. Limited-edition wildlife and landscape photography by Nic Miller.' }
